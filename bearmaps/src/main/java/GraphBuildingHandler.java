...
public class GraphBuildingHandler extends DefaultHandler {
     ...
     */
    private static List<String> arr = Arrays.asList("motorway", "trunk", "primary",
            "secondary", "tertiary", "unclassified", "residential",
            "living_street", "motorway_link", "trunk_link", "primary_link", "secondary_link",
            "tertiary_link");
    private static final HashSet<String> ALLOWED_HIGHWAY_TYPES = new HashSet<String>(arr);
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            //store the values in a graph.
            g.addVertex(nodeId, lon, lat);
            ...
            long wayID = Long.parseLong(attributes.getValue("ref"));
            connections.add(wayID);
            /*
